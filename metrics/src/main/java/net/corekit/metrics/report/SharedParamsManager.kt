...
object SharedParamsManager {
    ...
    private const val KEY_AD_NETWORK = "browser_n6fads4t2"
    private const val KEY_CAMPAIGN = "browser_o3xfao8w1"
    private const val KEY_ADGROUP = "browser_p7jfaosdk9"
    private const val KEY_CREATIVE = "browser_q4jfa3v5"
    private const val KEY_LOGIN_DAY = "browser_r1jfao8"
    private const val KEY_IS_NEW = "browser_s9faodj3"
    private const val KEY_FIRST_INSTALL_DATE = "browser_tfjaod4"
